<?php
    ...
    $current = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM user WHERE id = '$currentId'"));
    ...
    if(isset($_POST['back'])){
        header('location: user.php?id='.$currentId);
        exit();
    }
                    ...
                    <div class="columns-area__panels__pane">
                        <div class="columns-area__panels__pane__inner">
                            ...
                            <div class="compose-panel">
                                ...
                                <div class="navigation-bar">
                                    <a href="profile.php?id=<?= $id ?>">
                                        <div class="account__avatar" style="width: 46px; height: 46px;">
                                            <img src="<?= '../userImages/'.$current['profile']?>">
                                        </div>
                                    </a>
                                    <div class="navigation-bar__profile">
                                            <a href="profile.php?id=<?= $id ?>">
                                                <strong class="navigation-bar__profile-account">@<?= trimMail($currentMail)?></strong>
                                            </a>
                                ...
                                <form class="compose-form" action="../php/otherProfile.php" method="post" enctype="multipart/form-data">
                                    <div class="compose-form__autosuggest-wrapper">
                                        <input type="hidden" value="<?= $id;?>" name="id">
                                        <textarea type="text" placeholder="Write something to <?= $row['name'];?>" class="autosuggest-textarea__textarea" style="height: 27px !important;" name="post"></textarea>
                                    </div>
                                    ...
                                    <div class="compose-form__publish">
                                        <div class="compose-form__publish-button-wrapper">
                                            <button class="button button--block" type="submit" name="submit">Send!</button>
                                        </div>
                                    </div>
                                </form>
                                                ...
                                                <div class="account__header__bar">
                                                    <div class="account__header__tabs">
                                                        ...
                                                        <div class="account__header__tabs__buttons">
                                                            <a href="#"><button class="button logo-buton">Follow</button></a>                                                             
                                                        </div>
                                                    </div>
                                        ...
                                        <?php
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                                ...
                                                //  $dislikesCount = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS dislikes FROM ratings WHERE post_id = '$post_id' and status = 'dislike'"))['dislikes'];
                                                 ...
                                                 $status = mysqli_query($conn, "SELECT status FROM ratings WHERE post_id = '$post_id' AND user_id = '$currentId'");
                                                    ...
                                                    <div class="status__info">
                                                        ...
                                                        <a class="status__display-name" href="otherPp.php?id=<?= $row['userID'];?>">
                                                            ...
                                                            <span class="display-name">
                                                                <bdi>
                                                                    <strong class="display-name__html"><?= $row['dname'];?> 
                                                                        <span style="text-decoration: underline;"><?php if ($row['message'] != 0) { 
                                                                            $message = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM user WHERE id = '".$row['message']."'"));
                                                                            echo ' <i class="fa-solid fa-caret-right fa-lg" style="color: #ffffff;"></i> '.$message['name'];
                                                                        }?></span>
                                                                    </strong>
                                                                </bdi>
                                ...
                                <div class="navigation-panel">
                                    <div class="navigation-panel__logo">
                                        <a class="column-link column-link--logo" href="user.html">
                                            <img src="../icons
                                    /lucidwhite.png" style="height: 50px; width: 50px;">
                                            <h1>Lucid</h1>
                                        </a>
                                    </div>
                                    <hr>
                                    ...
                                    <a href="notifications.php" class="column-link column-link--transparent">
