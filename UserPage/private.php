                                ...
                                <div id="tabs-bar__portal">
                                    <div class="column-header__wrapper">
                                        <h1 class="column-header">
                                            <button class="feed"><div class="feedbtn"><i class="fa-solid fa-at"></i><p style="margin-left: 5px;">Private Mentions</p></div></button>
                                        </h1>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="columns-area__panels__pane columns-area__panels__pane--start">
                            <div class="columns-area__panels__pane__inner">
                                <div class="navigation-panel">
                                    ...
                                    <a class="column-link column-link--transparent active" href="private.php">
