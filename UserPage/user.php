                                ...
                                <div id="tabs-bar__portal">
                                    <div class="column-header__wrapper">
                                        <h1 class="column-header">
                                            <button class="feed"><div class="feedbtn"><img src="../Icons/house-32.png" class="homeFeed"><p>Home</p></div></button>
                                        </h1>
                                    </div>
                                </div>
                            </div>
                            <div class="columns-area columns-area--mobile">
                                <div class="column" role="region" aria-label="Home">
                                    <div class="scrollable">
                                        ...
                                        <?php
                                               $result = mysqli_query($conn, "SELECT * FROM `feeds` ORDER BY date DESC");
                                                        ...
                                                        <a class="status__display-name" href="otherPp.php?id=<?= $row['userID'];?>">
                                                            ...
                                                            <span class="display-name">
                                                                <bdi>
                                                                    ...
                                                                    <span style="text-decoration: underline; color: #FFF;"><?php if ($row['message'] != 0) { 
                                                                        $message = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM user WHERE id = '".$row['message']."'"));
                                                                        echo ' <i class="fa-solid fa-caret-right fa-lg" style="color: #ffffff; padding: 0 5px;"></i> '.$message['name'];
                                                                    }?></span>
                                                                </bdi>
                        ...
                        <div class="columns-area__panels__pane columns-area__panels__pane--start">
                            <div class="columns-area__panels__pane__inner">
                                <div class="navigation-panel">
                                    ...
                                    <hr>
                                    <a class="column-link column-link--transparent active" id="home" href="user.php">
                                        <img src="../Icons/house-32b.png" class="navIcons">
                                        <span>Home</span>
                                    </a>
